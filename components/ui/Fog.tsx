...
export default function Fog(props: FogProps) {
  ...
  const fogClassNames = classNames(
    "fixed left-0 right-0 h-32 pointer-events-none z-10 transition-opacity duration-300 ease-in-out",
    {
      "top-0 bg-gradient-to-b from-[var(--background)] via-[var(--background)]/50 to-transparent":
        side === "top",
